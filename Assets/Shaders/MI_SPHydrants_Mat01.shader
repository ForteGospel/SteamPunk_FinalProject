Shader "Unreal/MI_SPHydrants_Mat01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.300000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = (Material.ScalarExpressions[0].y * Local2.rgb);
	MaterialFloat Local4 = dot(Local3, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local5 = lerp(Local3,MaterialFloat3(Local4,Local4,Local4),MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat4 Local6 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.AmbientOcclusion = Local6.r;
