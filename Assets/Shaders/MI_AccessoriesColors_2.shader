Shader "Unreal/MI_AccessoriesColors_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.003922,0.223529,0.027451,1.000000);//
	Material.VectorExpressions[3] = float4(0.003922,0.223529,0.027451,0.000000);//
