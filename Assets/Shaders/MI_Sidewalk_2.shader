		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.325490,0.254902,0.254902,1.000000);//
	Material.VectorExpressions[5] = float4(0.325490,0.254902,0.254902,0.000000);//
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,0.000000);
	Material.ScalarExpressions[1] = float4(-0.000000,1.000000,0.000000,17.353291);
	Material.ScalarExpressions[2] = float4(0.000000,-0.460149,1.458316,0.000000);
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,1.368016,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Local8,View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local19 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local8,View.MaterialTextureMipBias));
