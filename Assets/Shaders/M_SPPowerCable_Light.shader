Shader "Unreal/M_SPPowerCable_Light"
{
	Properties
	{
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local0 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local1 = (Local0.rgb * 2.00000000);
