		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.086948,0.338542,0.092144,1.000000);//
	Material.VectorExpressions[3] = float4(0.086948,0.338542,0.092144,0.000000);//
	Material.VectorExpressions[4] = float4(0.003922,0.223529,0.027451,1.000000);//
	Material.VectorExpressions[5] = float4(0.003922,0.223529,0.027451,0.000000);//
