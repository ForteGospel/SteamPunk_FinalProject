Shader "Unreal/MI_AccessoriesColors"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.172431,0.378191,0.713542,1.000000);//
	Material.VectorExpressions[3] = float4(0.172431,0.378191,0.713542,0.000000);//
