Shader "Unreal/MI_BodyColors_10"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//
	Material.VectorExpressions[3] = float4(1.000000,1.000000,1.000000,0.000000);//
	Material.VectorExpressions[4] = float4(0.662745,0.705882,0.713726,1.000000);//
	Material.VectorExpressions[5] = float4(0.662745,0.705882,0.713726,0.000000);//
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = (Material.VectorExpressions[3].rgb * Local2.rgb);
	MaterialFloat3 Local4 = (Local2.a * Material.VectorExpressions[5].rgb);
	MaterialFloat3 Local5 = lerp(Local3,Local4,MaterialFloat(0.50000000));
	MaterialFloat4 Local6 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local7 = lerp(Local5,Local6.rgb,MaterialFloat(0.50000000));
	MaterialFloat4 Local8 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	...
	PixelMaterialInputs.Roughness = Local8.g;
