Shader "Unreal/MI_Balloonitself01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.003922,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	// Initial calculations (required for Normal)
	MaterialFloat4 Local0 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Parameters.TexCoords[1].xy,View.MaterialTextureMipBias));
	MaterialFloat Local1 = (MaterialFloat3(MaterialFloat2(Local0.r,Local0.g),1.00000000).b + 1.00000000);
	MaterialFloat4 Local2 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat2 Local3 = (Local2.rgb.rg * -1.00000000);
	MaterialFloat Local4 = dot(MaterialFloat3(MaterialFloat3(MaterialFloat2(Local0.r,Local0.g),1.00000000).rg,Local1), MaterialFloat3(Local3,Local2.rgb.b));
	MaterialFloat3 Local5 = (MaterialFloat3(MaterialFloat3(MaterialFloat2(Local0.r,Local0.g),1.00000000).rg,Local1) * Local4);
	MaterialFloat3 Local6 = (Local1 * MaterialFloat3(Local3,Local2.rgb.b));
	...
	MaterialFloat3 Local8 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	...
	MaterialFloat4 Local10 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local11 = (1.00000000 - Local0.b);
	MaterialFloat Local12 = (Local11 / 5.00000000);
	MaterialFloat Local13 = (Local10.g - Local12);

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = 0.64999998;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(MaterialFloat3(1.00000000,1.00000000,1.00000000),Material.ScalarExpressions[0].y);
