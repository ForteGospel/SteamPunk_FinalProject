Shader "Unreal/MI_AccessoriesColors_5"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.600000,0.713726,0.313726,1.000000);//
	Material.VectorExpressions[3] = float4(0.600000,0.713726,0.313726,0.000000);//
