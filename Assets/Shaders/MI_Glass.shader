		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.239216,0.239216,0.239216,1.000000);//
	Material.VectorExpressions[3] = float4(0.239216,0.239216,0.239216,0.000000);//
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.100000,0.500000);
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[0].w;
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(MaterialFloat2(MaterialFloat2(1.00000000,0.00000000).r,0).r,Material.ScalarExpressions[1].x);
