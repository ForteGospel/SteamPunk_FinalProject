		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.276042,0.276042,0.276042,1.000000);//
	Material.VectorExpressions[5] = float4(0.276042,0.276042,0.276042,0.000000);//
	...
	Material.ScalarExpressions[2] = float4(0.000000,1.000000,3.000000,1.000000);
	Material.ScalarExpressions[3] = float4(0.000000,1.000000,0.000000,1.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = (Local0.rgb.b + 1.00000000);
	MaterialFloat2 Local2 = ((MaterialFloat2(0.50000000,-0.50000000) * -1.00000000) + Parameters.TexCoords[0].xy);
	MaterialFloat Local3 = dot(Local2, Material.VectorExpressions[1].rg);
	MaterialFloat Local4 = dot(Local2, Material.VectorExpressions[2].rg);
	MaterialFloat2 Local5 = (MaterialFloat2(0.50000000,-0.50000000) + MaterialFloat2(Local3,Local4));
	MaterialFloat Local6 = (Local5.r + Material.ScalarExpressions[1].z);
	MaterialFloat Local7 = (Local6 * Material.ScalarExpressions[1].w);
	MaterialFloat Local8 = (Local5.g + Material.ScalarExpressions[2].x);
	MaterialFloat Local9 = (Local8 * Material.ScalarExpressions[2].y);
	MaterialFloat2 Local10 = (MaterialFloat2(Local7,Local9) * Material.ScalarExpressions[2].z);
	MaterialFloat4 Local11 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local10,View.MaterialTextureMipBias));
	MaterialFloat2 Local12 = (Material.ScalarExpressions[2].w * MaterialFloat2(Local11.rgb.r,Local11.rgb.g));
	MaterialFloat2 Local13 = (MaterialFloat3(Local12,Local11.rgb.b).rg * -1.00000000);
	MaterialFloat Local14 = dot(MaterialFloat3(Local0.rgb.rg,Local1), MaterialFloat3(Local13,MaterialFloat3(Local12,Local11.rgb.b).b));
	MaterialFloat3 Local15 = (MaterialFloat3(Local0.rgb.rg,Local1) * Local14);
	MaterialFloat3 Local16 = (Local1 * MaterialFloat3(Local13,MaterialFloat3(Local12,Local11.rgb.b).b));
	...
	MaterialFloat3 Local18 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[3].x));
	MaterialFloat4 Local19 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local10,View.MaterialTextureMipBias));
	MaterialFloat3 Local20 = (Material.VectorExpressions[5].rgb * Local19.rgb);
	MaterialFloat3 Local21 = (Material.ScalarExpressions[3].y * Local20);
	MaterialFloat4 Local22 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local10,View.MaterialTextureMipBias);
	MaterialFloat Local23 = (Local22.g * Material.ScalarExpressions[3].w);
	...
	PixelMaterialInputs.AmbientOcclusion = Local22.r;
