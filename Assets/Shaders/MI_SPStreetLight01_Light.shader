Shader "Unreal/MI_SPStreetLight01_Light"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,0.156285,0.000000,1.000000);//
	Material.VectorExpressions[2] = float4(1.000000,0.156285,0.000000,0.000000);//
	Material.VectorExpressions[3] = float4(15.000000,2.344275,0.000000,0.000000);//
	Material.VectorExpressions[4] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.ScalarExpressions[0] = float4(15.000000,0.000000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(Material.VectorExpressions[3].rgb,Material.VectorExpressions[4].rgb,MaterialFloat(Material.ScalarExpressions[0].y));
