		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.260417,0.103271,0.066769,1.000000);//
	Material.VectorExpressions[3] = float4(0.260417,0.103271,0.066769,0.000000);//
	Material.VectorExpressions[4] = float4(0.850980,0.356863,0.090196,1.000000);//
	Material.VectorExpressions[5] = float4(0.850980,0.356863,0.090196,0.000000);//
