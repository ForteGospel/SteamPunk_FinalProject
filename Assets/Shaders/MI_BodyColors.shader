		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.138432,0.033105,0.084376,1.000000);//
	Material.VectorExpressions[3] = float4(0.138432,0.033105,0.084376,0.000000);//
	Material.VectorExpressions[4] = float4(0.034340,0.012983,0.016807,1.000000);//
	Material.VectorExpressions[5] = float4(0.034340,0.012983,0.016807,0.000000);//
