		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.598958,0.192982,0.505891,1.000000);//
	Material.VectorExpressions[3] = float4(0.598958,0.192982,0.505891,0.000000);//
	Material.VectorExpressions[4] = float4(0.713726,0.352941,0.556863,1.000000);//
	Material.VectorExpressions[5] = float4(0.713726,0.352941,0.556863,0.000000);//
