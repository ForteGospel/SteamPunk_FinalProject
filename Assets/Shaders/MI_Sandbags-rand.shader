Shader "Unreal/MI_Sandbags-rand"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,5.000000,0.350000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local2 = (GetPerInstanceRandom(Parameters) - 0.50000000);
	MaterialFloat Local3 = (Local2 / Material.ScalarExpressions[0].y);
	MaterialFloat Local4 = (Local3 * 6.28318548);
	...
	MaterialFloat3 Local6 = RotateAboutAxis(MaterialFloat4((MaterialFloat3(1.00000000,1.00000000,1.00000000) / sqrt(dot(MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat3(1.00000000,1.00000000,1.00000000)))),Local4),MaterialFloat3(0.00000000,0.00000000,0.00000000),Local5.rgb);
	MaterialFloat3 Local7 = (Local6 + Local5.rgb);
	MaterialFloat Local8 = dot(Local7, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local9 = (Local2 / Material.ScalarExpressions[0].z);
	MaterialFloat Local10 = abs(Local9);
	MaterialFloat3 Local11 = lerp(Local7,MaterialFloat3(Local8,Local8,Local8),MaterialFloat(Local10));
	MaterialFloat Local12 = (GetPerInstanceRandom(Parameters) / 8.00000000);
	MaterialFloat Local13 = min(max(Local12,0.00000000),1.00000000);
	MaterialFloat3 Local14 = (Local11 - Local13);
	MaterialFloat4 Local15 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));

	PixelMaterialInputs.EmissiveColor = Local1;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local14;
	PixelMaterialInputs.Metallic = Local15.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local15.g;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local15.r;
