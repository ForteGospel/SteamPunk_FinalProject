...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local3 = PositiveClampedPow(Local1.a,2.00000000);
	MaterialFloat2 Local4 = GetPixelPosition(Parameters);
	MaterialFloat Local5 = View.TemporalAAParams.x;
	MaterialFloat2 Local6 = (Local4 + MaterialFloat2(Local5,Local5));
	MaterialFloat Local7 = CustomExpression0(Parameters,Local6);
	MaterialFloat2 Local8 = (Local4 / MaterialFloat2(64.00000000,64.00000000));
	MaterialFloat4 Local9 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local8,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local10 = (Local9.r * 1.00000000);
	MaterialFloat Local11 = (Local7 + Local10);
	MaterialFloat Local12 = (Local11 / 6.00000000);
	MaterialFloat Local13 = (Local3 + Local12);
	MaterialFloat Local14 = (Local13 + -0.50000000);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local14;
	PixelMaterialInputs.BaseColor = Local1.rgb;
	PixelMaterialInputs.Metallic = Local2.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local2.g;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local2.r;
