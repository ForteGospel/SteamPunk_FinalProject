Shader "Unreal/M_TrafficLight01Mat01"
{
	Properties
	{
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local1 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local2 = (MaterialFloat3(0.00000000,1.00000000,0.00000000) * Local1.g);
	MaterialFloat3 Local3 = (Local2 * 13.00000000);
	MaterialFloat3 Local4 = (Local1.g * MaterialFloat3(1.00000000,0.00000000,0.00000000));
	MaterialFloat3 Local5 = (Local4 * 13.00000000);
	MaterialFloat Local6 = (View.GameTime * 0.31415927);
	MaterialFloat Local7 = sin(Local6);
	MaterialFloat Local8 = ceil(Local7);
	MaterialFloat3 Local9 = lerp(Local3,Local5,MaterialFloat(Local8));
	MaterialFloat3 Local10 = lerp(Local9,Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));

	PixelMaterialInputs.EmissiveColor = Local10;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local11.rgb;
	PixelMaterialInputs.Metallic = Local12.b;
