Shader "Unreal/M_SPSignBoard_Mat01"
{
	Properties
	{
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local2 = (Local1.rgb * 1.00000000);
	MaterialFloat3 Local3 = lerp(Local2,Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	...
	MaterialFloat4 Local5 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));

	PixelMaterialInputs.EmissiveColor = Local3;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local4.rgb;
	PixelMaterialInputs.Metallic = Local5.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = 0.50000000;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local5.r;
