		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.051469,0.138432,0.080033,1.000000);//
	Material.VectorExpressions[3] = float4(0.051469,0.138432,0.080033,0.000000);//
	Material.VectorExpressions[4] = float4(0.600000,0.713726,0.313726,1.000000);//
	Material.VectorExpressions[5] = float4(0.600000,0.713726,0.313726,0.000000);//
