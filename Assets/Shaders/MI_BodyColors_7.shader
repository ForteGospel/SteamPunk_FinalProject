		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.718750,0.116357,0.000000,1.000000);//
	Material.VectorExpressions[3] = float4(0.718750,0.116357,0.000000,0.000000);//
	Material.VectorExpressions[4] = float4(0.713726,0.003922,0.000000,1.000000);//
	Material.VectorExpressions[5] = float4(0.713726,0.003922,0.000000,0.000000);//
